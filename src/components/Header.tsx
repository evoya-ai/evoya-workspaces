    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <a href="#features" className="text-gray-700 hover:text-evoya-blue transition-colors">Funktionen</a>
          <a href="#benefits" className="text-gray-700 hover:text-evoya-blue transition-colors">Vorteile</a>
          <a href="#services" className="text-gray-700 hover:text-evoya-blue transition-colors">Dienstleistungen</a>
          <a href="#comparison" className="text-gray-700 hover:text-evoya-blue transition-colors">Vergleich</a>
          <a href="#contact" className="btn-primary py-2 px-4">Kontakt</a>
        </nav>

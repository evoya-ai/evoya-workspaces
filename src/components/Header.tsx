    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <a href="#features" className={`${isScrolled ? 'text-gray-700' : 'text-white !important'} hover:text-evoya-orange transition-colors font-medium`}>Funktionen</a>
          <a href="#benefits" className={`${isScrolled ? 'text-gray-700' : 'text-white !important'} hover:text-evoya-orange transition-colors font-medium`}>Vorteile</a>
          <a href="#services" className={`${isScrolled ? 'text-gray-700' : 'text-white !important'} hover:text-evoya-orange transition-colors font-medium`}>Dienstleistungen</a>
          <a href="#comparison" className={`${isScrolled ? 'text-gray-700' : 'text-white !important'} hover:text-evoya-orange transition-colors font-medium`}>Vergleich</a>

        ...
        <AnimatedSection className="mt-24 mb-24" animation="fade-up">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="relative h-[450px] overflow-hidden rounded-xl shadow-lg">
              ...
              {/* Middle left: Strukturierte Daten - Präzise Ausrichtung zum Mittelpunkt der Linie */}
              <div className="absolute top-[225px] left-0 transform translate-x-[12px] -translate-y-1/2 w-24 h-24 bg-white rounded-lg shadow-lg p-3 z-10 animate-float" style={{ animationDelay: '3s' }}>
              ...
              {/* Middle right: Analyse - Präzise Ausrichtung zum Mittelpunkt der Linie */}
              <div className="absolute top-[225px] right-0 transform translate-x-[-12px] -translate-y-1/2 w-24 h-24 bg-white rounded-lg shadow-lg p-3 z-10 animate-float" style={{ animationDelay: '4.5s' }}>
